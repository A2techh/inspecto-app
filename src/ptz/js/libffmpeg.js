...
var DYNAMIC_BASE = 6337552
  , DYNAMICTOP_PTR = 1094640;
...
var ___tm_timezone = (stringToUTF8("GMT", 1094544, 4),
1094544);
...
function jsCall_viiiif(index, a1, a2, a3, a4, a5) {
    functionPointers[index](a1, a2, a3, a4, a5)
}
...
var asmLibraryArg = {
    ...
    "q": jsCall_viiiiiiii,
    "p": jsCall_viiiiiiiii,
    "o": jsCall_viiiiiiiiii,
    "m": jsCall_viiiiiiiiiii,
    "l": jsCall_viiiiiiiiiiii,
    "k": jsCall_viiiiiiiiiiiiii,
    ...
    "O": _llvm_log2_f32,
    "_": _llvm_trunc_f64,
    "L": _pthread_cond_destroy,
    "K": _pthread_cond_init,
    "M": _pthread_cond_signal,
    "d": _pthread_cond_wait,
    "Q": _pthread_create,
    "P": _pthread_join,
    "Z": _sysconf,
    "Y": _usleep,
    "X": abortOnCannotGrowMemory,
    "a": DYNAMICTOP_PTR
};
var asm = Module["asm"](asmGlobalArg, asmLibraryArg, buffer);
Module["asm"] = asm;
var _Hi264DecCreate = Module["_Hi264DecCreate"] = function() {
    return Module["asm"]["la"].apply(null, arguments)
}
;
var _Hi264DecDestroy = Module["_Hi264DecDestroy"] = function() {
    return Module["asm"]["ma"].apply(null, arguments)
}
;
var _Hi264DecFrame = Module["_Hi264DecFrame"] = function() {
    return Module["asm"]["na"].apply(null, arguments)
}
;
var _Hi265DecCreate = Module["_Hi265DecCreate"] = function() {
    return Module["asm"]["oa"].apply(null, arguments)
}
;
var _Hi265DecDestroy = Module["_Hi265DecDestroy"] = function() {
    return Module["asm"]["pa"].apply(null, arguments)
}
;
var _Hi265DecFrame = Module["_Hi265DecFrame"] = function() {
    return Module["asm"]["qa"].apply(null, arguments)
}
;
var _HiFree = Module["_HiFree"] = function() {
    return Module["asm"]["ra"].apply(null, arguments)
}
;
var _HiMalloc = Module["_HiMalloc"] = function() {
    return Module["asm"]["sa"].apply(null, arguments)
}
;
var _HiMemcpy = Module["_HiMemcpy"] = function() {
    return Module["asm"]["ta"].apply(null, arguments)
}
;
Module["writeArrayToMemory"] = writeArrayToMemory;
var _HiMemset = Module["_HiMemset"] = function() {
    return Module["asm"]["ua"].apply(null, arguments)
}
;
var _HiStrcpy = Module["_HiStrcpy"] = function() {
